...
@pytest.mark.flaky(reruns=2, reruns_delay=2)  # 2 powtórki, 2s przerwy między nimi
def test_multiple_products_total_calculation(home_page_selenium, login_page_selenium, product_page_selenium):
    ...
    # Upewnij się, że w POM clear_cart() ma na końcu powrót do BIKE_MAIN_LINK!
    ...
    # Zmniejszyłeś count do 3 - bardzo rozsądnie dla stabilności Selenium
